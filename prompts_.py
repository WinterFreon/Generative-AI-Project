...
Provide a concise single-sentence hint to the student about one bug in the student's buggy code. Additionally, provide a brief explanation of why this hint is useful. Output your hint between [HINT] and [/HINT] and the explanation between [EXPLANATION] and [/EXPLANATION].
"""
